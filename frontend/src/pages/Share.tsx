...
const ERR: Record<string, string> = {
  ...
  user_not_found: 'No account found for that email. They need a ScopeBook login first.',
    ...
    <div>
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="card space-y-2.5">
          ...
          <p className="text-[11px] text-gray-400">For a teammate, sub, or adjuster with a ScopeBook login. Editors can add and change job data; viewers and estimators are read-only.</p>
        </div>
