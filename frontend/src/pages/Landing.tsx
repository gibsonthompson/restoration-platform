    ...
    <div className="h-[100dvh] overflow-y-auto bg-white text-navy">
      ...
      <section id="how" className="max-w-6xl mx-auto px-5 py-14 sm:py-20 scroll-mt-16">
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center mt-10 sm:mt-14">
          ...
          <div className="relative">
            <div className="mx-auto w-[260px] sm:w-[300px]"><Shot kind="phone" label="Moisture Map & Room Sketch" file="/site/ui-moisture-map.png" /></div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center mt-16 sm:mt-24">
          <div className="order-2 lg:order-1 relative">
            <div className="mx-auto w-[260px] sm:w-[300px]"><Shot kind="phone" label="Carrier-Ready Report & Share Link" file="/site/ui-report.png" /></div>
      ...
      <section className="max-w-6xl mx-auto px-5 py-14 sm:py-20">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          ...
          <div className="relative">
            <div className="mx-auto w-[260px] sm:w-[300px]"><Shot kind="phone" label="Daily Drying Log With GPP Chart" file="/site/ui-drying-log.png" /></div>
      ...
      <section id="xactimate" className="bg-sky-soft/30 scroll-mt-16">
        <div className="max-w-6xl mx-auto px-5 py-14 sm:py-20 grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          <div className="order-2 lg:order-1"><div className="mx-auto w-[260px] sm:w-[300px]"><Shot kind="phone" label="Xactimate Sketch Underlay (Scaled, to Trace)" file="/site/ui-underlay.png" /></div></div>
          <div className="order-1 lg:order-2">
