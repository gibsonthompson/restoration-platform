...
// CEILING HEIGHT IS NOT SET HERE.
//
// It is a MEASUREMENT, and it belongs where the tech is measuring: inside the sketch.
// Having it on the structure page, the room page and the sketch was three doors into one
// number, and three doors into one number is how the three of them end up disagreeing.
// The sketch editor writes resto_rooms.height_ft and that is the only source.
